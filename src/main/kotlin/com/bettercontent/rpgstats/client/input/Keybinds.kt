package com.bettercontent.rpgstats.client.input
...
object KeybindRegister {
    private const val OPEN_STATS_KEY = "key.rpg_stats.open_stats"
    private const val KEY_CATEGORY = "key.categories.rpg_stats"
